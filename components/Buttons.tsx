...
const Buttons = ({solveWithSteps,solveInstantly,generateRandom,clearBoard}:ButtonsProps) => {
    return (
        <div className="flex justify-center items-center">
            ...
            <button onClick={generateRandom} className='p-4 m-4 border cursor-pointer'>Generate random puzzle</button>
            <button onClick={clearBoard} className='p-4 m-4 border cursor-pointer'>Clear Board</button>
        </div>
    )
}
